...
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.UkrPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.histPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.mathPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.physPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.chemPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.bioPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.geoPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.engPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.fraPTName
...
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.deuPTName
...
SELECT tbl_zno_results.fraTest, tbl_zno_results.fraTestStatus,  CAST(REPLACE(tbl_zno_results.fraBall100, ',', '.') AS decimal),
    ...
    tbl_zno_results.fraDPALevel, tbl_zno_results.outid, tbl_zno_subject.id, tbl_zno_pt.id
FROM tbl_zno_results
JOIN tbl_zno_pt ON tbl_zno_pt.name = tbl_zno_results.spaPTName
JOIN tbl_zno_subject ON tbl_zno_subject.name = 'spa'
ON CONFLICT DO NOTHING;
